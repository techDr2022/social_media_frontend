...
export async function GET(
  ...
  try {
    ...
    console.log(`[YouTube Videos API] Fetching videos for account: ${accountId}, page: ${page}, limit: ${limit}`);
    
    let response;
    try {
      response = await fetch(`${cleanBackendUrl}/social-accounts/youtube/${accountId}/videos?page=${page}&limit=${limit}`, {
        method: "GET",
        headers: {
