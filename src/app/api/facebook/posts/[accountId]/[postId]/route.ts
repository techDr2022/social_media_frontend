...
export async function DELETE(
  ...
  try {
    ...
    const backendPath = `${cleanBackendUrl}/api/v1/facebook/posts/${accountId}/${postId}`;
    console.log(`[Facebook API] Deleting post ${postId} for account: ${accountId} from ${backendPath}`);
