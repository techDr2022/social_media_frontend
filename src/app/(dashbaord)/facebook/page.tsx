...
import { Facebook, Check, Loader2, RefreshCw, ArrowRight } from "lucide-react";
...
export default function FacebookHubPage() {
  ...
  async function connectFacebook() {
    ...
    try {
      ...
      setStatus(`Failed to start Facebook OAuth (${res.status})`);
      setConnecting(false);
    } catch (err: any) {
      console.error('OAuth error:', err);
      setStatus(`Failed to start Facebook OAuth: ${err.message}`);
      setConnecting(false);
    }
  }
  ...
  return (
    <MainLayout
      title="Facebook"
      subtitle="Manage your Facebook Pages and publish content"
    >
          ...
          <Card>
            <CardContent className="pt-12 pb-12">
              <div className="max-w-md mx-auto text-center">
                ...
                <CardTitle className="mb-2">No Facebook Pages connected</CardTitle>
                <CardDescription className="mb-6">
                  Connect your Facebook Pages to start posting and scheduling content.
                </CardDescription>
                <Button
                  onClick={connectFacebook}
                  disabled={connecting}
              ...
              >
                <Card className="h-full hover:shadow-lg hover:border-primary/30 transition-all duration-200">
                  <CardHeader>
                    ...
                    <CardDescription>Page ID: {acc.externalId}</CardDescription>
                  </CardHeader>
                  <CardContent>
